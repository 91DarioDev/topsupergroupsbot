...
this_command_only_private = "{} è solo per le chat private"
this_command_only_admins = "{} è solo per il creatore o gli admin nei gruppi"
this_command_only_creator = "{} è solo per il creatore nei gruppi"
